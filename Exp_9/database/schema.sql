...
-- ============================================================
--  ADMIN PANEL MIGRATION (run if upgrading existing install)
--  Adds description column if not already present
-- ============================================================
-- ALTER TABLE products ADD COLUMN IF NOT EXISTS description TEXT NULL AFTER category;
